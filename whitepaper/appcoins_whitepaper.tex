...
% size of mobile market and app stores: 2.1 billion users and $77B gross revenue.

% todays problems in app stores: --

% those problems lead to a concentration in two players with 90% of the market outside China; the reason is the lack of trust among industry players and lack of standartization

% what AppCoins is proposing 



% Bootstrap

% consequences: open, circular, shared  & results. 
