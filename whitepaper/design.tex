...
To assure that the app's process is bound to app store, Binder and PackageManager APIs can be used. To verify whether an app process is in the foreground, both ActivityManager, UserStatsManager and %or?
...
The IAB has only two functions related with the purchase: \textsf{IAB.CreateCatalog} and \textsf{IAB.Create Transaction}. \\
